              ...
              filteredSessions.map((session, idx) => (
                <tr key={idx} style={{ borderBottom: '1px solid rgba(255, 255, 255, 0.04)', transition: 'background 0.15s ease' }}>
                  ...
                  <td style={{ padding: '14px 16px' }}>
                    ...
                    <div style={{ fontSize: '0.75rem', color: 'var(--accent-ndrf-orange)', fontFamily: 'var(--font-mono)' }}>{session.scenarioCode}</div>
                  </td>
                  <td style={{ padding: '14px 16px' }}>
                    <div style={{
                      fontSize: '1.1rem',
                  ...
                  <td style={{ padding: '14px 16px', color: 'var(--text-secondary)' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                      ...
                      {Math.floor((session.totalDurationSeconds || 0) / 60)}m {(session.totalDurationSeconds || 0) % 60}s
                    </div>
                  </td>
